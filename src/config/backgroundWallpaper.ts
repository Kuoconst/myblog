...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/citlali-banner-1.png",
			"assets/images/DesktopWallpaper/citlali-banner-2.webp",
			"assets/images/DesktopWallpaper/citlali-banner-3.webp",
		],
		// 移动背景图片（支持单张或多张随机）
		// mobile: "assets/images/MobileWallpaper/m1.avif",
		mobile: [
			"assets/images/MobileWallpaper/citlali-phone-1.webp",
			"assets/images/MobileWallpaper/citlali-phone-2.webp",
			"assets/images/MobileWallpaper/citlali-phone-3.webp",
			"assets/images/MobileWallpaper/citlali-phone-4.webp",
			"assets/images/MobileWallpaper/citlali-phone-5.jpg",
			"assets/images/MobileWallpaper/citlali-phone-6.webp",
		],
		// 背景视频播放地址
		// 支持单个视频路径（字符串）或多个视频循环（数组，参考上面壁纸配置）
		// 支持远程视频URL，本地视频请放在 public/assets/videos/ 目录下
		// playerUrl: "/assets/videos/citlali.mp4",
			...
			links: [
				{
					...
					url: "https://github.com/Kuoconst/myblog",
					showName: true,
				},
				{
					name: "Email",
